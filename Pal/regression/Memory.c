...
#define UNIT (pal_public_state.alloc_align)
...
int main(int argc, char** argv, char** envp) {
    ...
    /* TODO: This does not take into account `pal_public_state.preloaded_ranges`; we are not allowed
     * to ask for memory overlapping with these ranges */
    void* mem3 = (void*)pal_public_state.user_address.start;
    void* mem4 = (void*)pal_public_state.user_address.start + UNIT;
